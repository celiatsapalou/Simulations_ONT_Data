...
process_bed_file <- function(bed_file, fasta_file, output_file, outfile_modifications_bed, mutation_length=500) {
  ...
  for (i in nrow(bed_data):1) {
    ...
    cat("Processing record:", i, "- Chrom:", chrom, "SV Start:", sv_start, "SV End:", sv_end, "\n")
